...
if __name__ == '__main__':
    ...
    spark_start = SparkSession.builder.appName("ten_year_wage_data_to_mongoDB").getOrCreate()
    
    # raw pull (change to hdfs on live run)
    txt_file = spark_start.sparkContext.textFile("hdfs:///user/maria_dev/number_of_workers/total_nonfarm_monthly.txt")
    ...
    yw_DF = spark.createDataFrame(users)
